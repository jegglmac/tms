...
const shipmentDetails = [
  {
    ...
    trackingEvents: [
      { time: '2025-07-12 09:00', event: 'Shipment created', location: 'Los Angeles, CA' },
      { time: '2025-07-12 14:30', event: 'Vehicle assigned', location: 'Los Angeles, CA' },
      { time: '2025-07-13 08:00', event: 'Pickup scheduled', location: 'Los Angeles, CA' }
    ]
  },
  {
    id: 'SH-12346',
    ...
    distance: '808 miles',
    estimatedDelivery: '2025-07-15 10:00',
    actualDelivery: null,
    ...
    pickupTime: '2025-07-12 10:00',
    deliveryWindow: '2025-07-15 09:00 - 12:00',
    trackingEvents: [
      { time: '2025-07-12 08:00', event: 'Shipment created', location: 'San Francisco, CA' },
      { time: '2025-07-12 10:00', event: 'Picked up', location: 'San Francisco, CA' },
      { time: '2025-07-12 16:30', event: 'In transit', location: 'Sacramento, CA' },
      { time: '2025-07-13 11:00', event: 'Rest stop', location: 'Portland, OR' }
    ]
  },
  {
    id: 'SH-12347',
    ...
    trackingEvents: [
      { time: '2025-07-12 11:00', event: 'Shipment created', location: 'Dallas, TX' },
      { time: '2025-07-12 15:00', event: 'Awaiting assignment', location: 'Dallas, TX' }
    ]
  },
  {
    id: 'SH-12348',
    customerName: 'Medical Supplies Ltd',
    customerEmail: 'orders@medsupplies.com',
    customerPhone: '+1 (555) 456-7890',
    status: 'Delivered',
    priority: 'Critical',
    origin: '999 Medical Way, Boston, MA',
    destination: '111 Hospital Dr, New York, NY',
    distance: '215 miles',
    estimatedDelivery: '2025-07-12 12:00',
    actualDelivery: '2025-07-12 11:45',
    assignedVehicle: 'TMS-004',
    assignedDriver: 'Emma Davis',
    cargo: 'Medical Equipment',
    weight: '850 lbs',
    dimensions: '4x3x2 ft',
    value: '$125,000',
    specialInstructions: 'Critical medical supplies - priority delivery',
    pickupTime: '2025-07-12 08:00',
    deliveryWindow: '2025-07-12 11:00 - 13:00',
    trackingEvents: [
      { time: '2025-07-11 16:00', event: 'Shipment created', location: 'Boston, MA' },
      { time: '2025-07-11 18:00', event: 'Vehicle assigned', location: 'Boston, MA' },
      { time: '2025-07-12 08:00', event: 'Picked up', location: 'Boston, MA' },
      { time: '2025-07-12 11:45', event: 'Delivered', location: 'New York, NY' }
    ]
  },
  {
    id: 'SH-12349',
    ...
    trackingEvents: [
      { time: '2025-07-11 14:00', event: 'Shipment created', location: 'Denver, CO' },
      { time: '2025-07-12 06:00', event: 'Picked up', location: 'Denver, CO' },
      { time: '2025-07-12 18:00', event: 'Delayed due to traffic', location: 'Route 66' },
      { time: '2025-07-13 10:00', event: 'Resumed journey', location: 'Flagstaff, AZ' }
    ]
  }
];
...
export default function Dashboard() {
  ...
  const tabs = [
    ...
    { id: 'shipments', name: 'Shipment Tracking', icon: ClipboardDocumentListIcon },
  ...
  const handleStatsCardClick = (cardName: string) => {
    ...
    } else if (cardName === 'Pending Shipments') {
    ...
    {showShipmentModal && (
      <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div className="relative top-20 mx-auto p-5 border w-11/12 max-w-7xl shadow-lg rounded-md bg-white">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-2xl font-bold text-gray-900">Shipment Management Dashboard</h3>
            <button
          ...
          <div className="bg-white shadow overflow-hidden rounded-md">
            <div className="px-4 py-5 sm:px-6">
              <h4 className="text-lg leading-6 font-medium text-gray-900">Shipment Tracking</h4>
              <p className="mt-1 max-w-2xl text-sm text-gray-500">Comprehensive shipment information and tracking details</p>
            </div>
            <div className="border-t border-gray-200">
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tr key={shipment.id} className="hover:bg-gray-50">
                          ...
                          <div className="flex items-center">
                            <div className="flex-shrink-0 h-10 w-10">
                              <div className={`h-10 w-10 rounded-full flex items-center justify-center ${
                                shipment.priority === 'Critical' ? 'bg-red-600' :
                                shipment.priority === 'High' ? 'bg-orange-600' :
                                shipment.priority === 'Medium' ? 'bg-yellow-600' : 'bg-green-600'
                              }`}>
                                <span className="text-xs font-medium text-white">
                                  {shipment.priority === 'Critical' ? 'C' :
                                   shipment.priority === 'High' ? 'H' :
                                   shipment.priority === 'Medium' ? 'M' : 'L'}
                                </span>
                              </div>
                            </div>
                            <div className="ml-4">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">
                            ...
                            <div className="text-xs text-gray-600 ml-5 mb-2">{shipment.origin}</div>
                            <div className="flex items-center mb-1">
                              <MapPinIcon className="h-4 w-4 text-green-500 mr-1" />
                              <span className="text-xs font-medium">To:</span>
                            </div>
                            <div className="text-xs text-gray-600 ml-5">{shipment.destination}</div>
                            <div className="text-xs text-blue-600 mt-1">{shipment.distance}</div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">
                            {shipment.assignedVehicle ? (
                              <>
                                <div className="flex items-center mb-1">
                                  <TruckIcon className="h-4 w-4 text-gray-400 mr-1" />
                                  <span className="font-medium">{shipment.assignedVehicle}</span>
                                </div>
                                <div className="flex items-center text-xs text-gray-500">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm">
                            <div className="font-medium text-gray-900">{shipment.cargo}</div>
                            <div className="text-xs text-gray-600">
                              <div>{shipment.weight}</div>
                              <div>{shipment.dimensions}</div>
                            </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm">
                            <div className="text-xs text-gray-600 mb-1">
                              <span className="font-medium">Pickup:</span> {shipment.pickupTime}
                            </div>
                            <div className="text-xs text-gray-900 font-medium">
                              <span>ETA:</span> {shipment.estimatedDelivery}
                            </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm">
                            <div className="font-medium text-gray-900">{shipment.value}</div>
                          </div>
                        </td>
                      </tr>
                    ))}
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="space-y-2">
                <button className="w-full text-left text-xs text-blue-700 hover:text-blue-900">
                  + Create New Shipment
                </button>
                <button className="w-full text-left text-xs text-blue-700 hover:text-blue-900">
                  📋 Bulk Update Status
            ...
            <div className="bg-yellow-50 p-4 rounded-lg">
              <h5 className="text-sm font-medium text-yellow-900 mb-2">Pending Actions</h5>
              <div className="text-xs text-yellow-700">
                <div>• 2 shipments need vehicle assignment</div>
                <div>• 1 shipment requires special handling approval</div>
                <div>• 3 delivery windows expiring today</div>
              </div>
            </div>
            <div className="bg-green-50 p-4 rounded-lg">
              <h5 className="text-sm font-medium text-green-900 mb-2">Today's Performance</h5>
              <div className="text-xs text-green-700">
                <div>• 96.5% On-time delivery rate</div>
                <div>• $298,000 Total shipment value</div>
                <div>• 1,285 miles Total distance</div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 flex justify-end space-x-3">
            ...
            <button
              onClick={() => {
                ...
                // Navigate to shipments management page
              }}
              className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
